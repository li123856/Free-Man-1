...
SpawnVehicle_InfrontOfPlayer(playerid, vehiclemodel, color1, color2)
{
	...
	return CallRemoteFunction("VehicleSystem_SpawnForPlayer", "ddffffdddc", playerid,vehiclemodel, x, y, z + (size_z * 0.25), facing, color1, color2,100,true);
...
//	if(!IsPlayerAdmin(playerid)) return 0;
	...
	if(strcmp("/vspawner13899", cmd, true) == 0)
	{
